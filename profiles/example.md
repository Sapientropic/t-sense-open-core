...
- **Location constraint**: Single-office roles are not acceptable
...
- Salary expectation: Competitive market rate for senior frontend work
...
## Report Preferences
- Keep low-priority roles when they are useful boundary examples, such as office-only or junior roles
...
## Report Labels
report_title: "T-Sense Signal Report"
...
stats_label: "Matches"
output_filename: "t-sense-signal-report-{date}.md"
-->
