"""Cross-platform Telegram signal scanner with optional media OCR.
...
Reads config and session from ~/.config/t-sense/ by default.
"""
...
CONFIG_DIR = Path(
    os.environ.get("T_SENSE_CONFIG_DIR")
    or os.path.join(
