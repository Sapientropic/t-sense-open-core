...
class DailyReportTests(unittest.TestCase):
    def test_default_report_output_path_uses_scan_date(self):
        ...
        self.assertEqual(path, Path("output") / "t-sense-signal-report-2026-05-06.md")
    ...
    def test_main_runs_scan_then_report_with_this_run_scan_file(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            output_dir.mkdir()
            report_file = output_dir / "t-sense-signal-report-2026-05-06.md"
            calls = []
    ...
    def test_html_report_uses_single_report_call_with_html_output(self):
        ...
        with tempfile.TemporaryDirectory() as tmp:
            ...
            output_dir.mkdir()
            report_file = output_dir / "t-sense-signal-report-2026-05-06.md"
            html_file = output_dir / "t-sense-signal-report-2026-05-06.html"
            calls = []
