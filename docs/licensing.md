...
T-Sense uses a dual-license model for this community open-core repository:
...
The community repository contains the local scanner, profile-driven reports,
optional OCR/STT helpers, report templates, public examples, tests, and public
documentation.

It does not include private product layers: managed dashboards, recommendation
or join workflows, hosted services, commercial workflows, branded experiences,
private datasets, packaged app distribution, or private product strategy.

Those excluded layers may be licensed, sold, or distributed separately by
Sapientropic. Their absence from this repository is intentional and should not
be treated as a missing community feature.
